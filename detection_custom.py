...
video_path   = "./IMAGES/1611844677114343.mp4"


#yolo = Create_Yolo(input_size=YOLO_INPUT_SIZE, CLASSES=TRAIN_CLASSES)
#yolo.load_weights("./checkpoints/yolov3_custom") # use keras weights， i add
yolo = Load_Yolo_model()
#detect_image(yolo, image_path, "./IMAGES/drone1.png", input_size=YOLO_INPUT_SIZE, show=True, CLASSES=TRAIN_CLASSES, rectangle_colors=(255,0,0))
detect_video(yolo, video_path, "", input_size=YOLO_INPUT_SIZE, show=True, CLASSES=TRAIN_CLASSES, score_threshold=0.2,rectangle_colors=(255,0,0))
