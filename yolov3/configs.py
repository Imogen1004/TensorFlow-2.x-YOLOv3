...
YOLO_CUSTOM_WEIGHTS         = "checkpoints/yolov3_custom_Tiny" #"checkpoints/yolov3-trt-FP32-416" # used in evaluate_mAP.py and custom model detection, if not using leave False
